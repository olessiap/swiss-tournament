...
def testCount():
    ...
    registerPlayer("Chandra Nalaar") #4
    c = countPlayers() #3
    if c != 1:
        raise ValueError(
...
def testStandingsBeforeMatches():
    ...
    standings = playerStandings() #5 list of the players and their win records, sorted by wins
    if len(standings) < 2:
    ...
    [(id1, name1, wins1, matches1), (id2, name2, wins2, matches2)] = standings #  2 columns
